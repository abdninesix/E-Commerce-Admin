...
const CollectionForm: React.FC<CollectionFormProps> = ({initialData}) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      setLoading(true)
      const url = initialData ? `/api/collections/${initialData._id}` : "/api/collections"; //Another way to do this is const params = useParams() and then replace initialData._id with params.collecitonId
